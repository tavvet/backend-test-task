...
final readonly class PriceCalculationDataResolver implements ValueResolverInterface
{
    ...
    {
        if (PriceCalculationData::class !== $argument->getType()) {
            return [];
        }
